...
//=============================================================================
class CButtonExProp : public CMFCPropertyGridProperty
{
public:
	CButtonExProp(const CString& strName, const COleVariant& varValue, CWnd* pParentWnd, UINT nID);

	virtual ~CButtonExProp();
...
//=============================================================================
class CButtonTrProp : public CMFCPropertyGridProperty
{
public:
	CButtonTrProp(const CString& strName, const COleVariant& varValue, UINT nWM, UINT nWParam);
