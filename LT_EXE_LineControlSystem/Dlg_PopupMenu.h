...
// Purpose	:	 
//*****************************************************************************
#ifndef Dlg_PopupMenu_h__
#define Dlg_PopupMenu_h__
...
//=============================================================================
class CDlg_PopupMenu : public CDialogEx
{
	DECLARE_DYNAMIC(CDlg_PopupMenu)

public:
	CDlg_PopupMenu(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CDlg_PopupMenu();

	afx_msg int		OnCreate				(LPCREATESTRUCT lpCreateStruct);
	afx_msg void	OnSize					(UINT nType, int cx, int cy);
	afx_msg void	OnWindowPosChanging		(WINDOWPOS* lpwndpos);
	afx_msg void	OnBnClicked_CtrlCmd		(UINT nID);
...
protected:
	...
	// 설비 제어 명령어 버튼
	CMFCButton		m_bn_CtrlCmd[enConrolCode::CC_MaxCount];
